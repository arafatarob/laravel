            ...
            <div class="row">
                ...
                <div class="col-xs-12 main-content">
                    <div class="header-lined" style="">
                        <ol class="breadcrumb">
                            <li>
                                <a href="https://web.archive.org/web/20231129174750/https://ecab.io/" class="">
                                    Accueil</a>
                            </li>
                                ...
                                <div class>
                                    <div id="services">
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="row-title">Fonctionnalités</div>
                                                    <div class="h2_svg animate__animated animate__faster animate__zoomInRight"
                                                        data-animate-class="animate__zoomInRight"
                                                        style="animation-delay: 400ms; text-align: center">
                                                        <span style="fill: red; width:22rem;"> <svg version="1.1"
                                                                id="h2svg19" xmlns="http://www.w3.org/2000/svg"
                                                                xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
                                                                y="0px" viewBox="0 0 500 50"
                                                                style="enable-background:new 0 0 500 50;"
                                                                xml:space="preserve">
                                                                <g>
      		...
      		c1.8,0.1,3.7,0.1,5.5,0.3C343.2,34.3,338,32.9,331.8,32.4z"></path>
                                                    ...
                                                    <div class="row-subtitle " style="margin-bottom:36px">Gérez votre
                                                        société de transport de personnes en toute tranquillité !</div>
                                                </div>
                                            </div>
                                            <div class="row fonctionnalites-tab-row">
                                                <div id="feature-box1">
                                                    <div class="col-sm-12 col-md-6">
                                                        <div style=" " class="service-box">
                                                            <div class="row" style="padding-left: 15px; ">
                                                                <div class="col-lg-4 col-md-4 col-12">
                                                                    <div class>
                                                                        <img class src=" assets/images/clients.jpg" alt
                                                                            style="width:250px">
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-8 col-md-8 col-12"
                                                                    style="padding-left:77px; text-align:justify">
                                                                    <div
                                                                        class="service-title fonctionnalites-service-title">
                                                                        <a href="#">Clients</a></div>
                                                                    <div
                                                                        class="service-details fonctionnalites-service-details">
                                                                        <p>La liste de tous vos clients est disponible
                                                                            et se
                                                                            met à jour automatiquement. Suivez toutes
                                                                            les
                                                                            prestations et les
                                                                        </p>
                                                                        <div class="arrow"><i
                                                                        ...
                                                                        <p class="more-text" style="display: none;">
                                                                            courses pour simplifier votre communication,
                                                                            vos factures et vos résultats.
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-sm-12 col-md-6">
                                                        <div style=" " class="service-box">
                                                            <div class="row" style="padding-left: 15px; ">
                                                                <div class="col-lg-4 col-md-4 col-12">
                                                                    <div class>
                                                                        <img class src=" assets/images/drivers.jpg" alt
                                                                            style="width:250px">
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-8 col-md-8 col-12"
                                                                    ...
                                                                    <div
                                                                        class="service-title fonctionnalites-service-title">
                                                                        <a href="#">Chauffeurs</a></div>
                                                                    <div
                                                                        class="service-details fonctionnalites-service-details">
                                                                        <p> Une liste de tous vos chauffeurs en service
                                                                            accessible en un clic. Idéal pour établir
                                                                            pour
                                                                            retrouver rapidement la liste</p>
                                                                        <div class="arrow"><i
                                                                                class="fa-solid fa-angle-down"></i>
                                                                        </div>
                                                                        <p class="more-text" style="display: none;">
                                                                            de vos
                                                                            employés et
                                                                            afin de communiquer plus facilement avec
                                                                            votre
                                                                            équipe.
                                                                        </p>
                                                                    </div>
                                                    ...
                                                    <div class="col-sm-12 col-md-6">
                                                        <div style=" " class="service-box">
                                                            <div class="row" style="padding-left: 15px; ">
                                                                <div class="col-lg-4 col-md-4 col-12">
                                                                    <div class>
                                                                        <img class src=" assets/images/partners.jpg" alt
                                                                            style="width:250px">
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-8 col-md-8 col-12"
                                                                    ...
                                                                    <div
                                                                        class="service-title fonctionnalites-service-title">
                                                                        <a href="#">Partenaires</a></div>
                                                                    <div
                                                                        class="service-details fonctionnalites-service-details">
                                                                        <p> Ajoutez tous les partenaires de votre
                                                                            société de
                                                                            transport dans cette partie et retrouvez
                                                                            leur
                                                                            contact en 1 clic.</p>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div class="col-sm-12 col-md-6">
                                                        <div style=" " class="service-box">
                                                            <div class="row" style="padding-left: 15px; ">
                                                                <div class="col-lg-4 col-md-4 col-12">
                                                                    <div class>
                                                                        <img class src=" assets/images/cars.jpg" alt
                                                                            style="width:250px">
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-8 col-md-8 col-12"
                                                                    ...
                                                                    <div
                                                                        class="service-title fonctionnalites-service-title">
                                                                        <a href="#">Voitures</a></div>
                                                                    <div
                                                                        class="service-details fonctionnalites-service-details">
                                                                        <p> Votre flotte de voitures est disponible ici.
                                                                            Vous pouvez gérer l’ensemble de vos
                                                                            véhicules
                                                                            depuis cette section. Pratique si vous devez
                                                                            retrouver une voiture en particulier.</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-12 col-md-6">
                                                        <div style=" " class="service-box">
                                                            <div class="row" style="padding-left: 15px; ">
                                                                <div class="col-lg-4 col-md-4 col-12">
                                                                    <div class>
                                                                        <img class src=" assets/images/bookings.jpg" alt
                                                                            style="width:250px">
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-8 col-md-8 col-12"
                                                                    ...
                                                                    <div
                                                                        class="service-title fonctionnalites-service-title">
                                                                        <a href="#">Réservations</a></div>
                                                                    <div
                                                                        class="service-details fonctionnalites-service-details">
                                                                        <p> Toutes les réservations effectuées par vos
                                                                            clients sont inscrites ici. Vous pouvez
                                                                            accéder
                                                                            à tous les détails. Idéal pour garder une
                                                                            trace
                                                                            de toutes vos prestations.</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-12 col-md-6">
                                                        <div style=" " class="service-box">
                                                            <div class="row" style="padding-left: 15px; ">
                                                                <div class="col-lg-4 col-md-4 col-12">
                                                                    <div class>
                                                                        <img class src=" assets/images/quotes.jpg" alt
                                                                            style="width:250px">
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-8 col-md-8 col-12"
                                                                    ...
                                                                    <div
                                                                        class="service-details fonctionnalites-service-details">
                                                                        <p> Vos clients et partenaires ont-ils besoin
                                                                            d’un
                                                                            devis ? Préparez toutes vos estimations à
                                                                            partir
                                                                            de cet onglet. Le logiciel vous aide à
                                                                            établir
                                                                            l’ensemble de vos devis très facilement.</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div id="feature-box2" style="display: none !important;">
                                                        ...
                                                        <div style=" " class="service-box">
                                                            <div class="row" style="padding-left: 15px; ">
                                                                ...
                                                                <div class="col-lg-8 col-md-8 col-12"
                                                                    ...
                                                                    <div
                                                                        class="service-title fonctionnalites-service-title">
                                                                        <a href="#">Facturation</a></div>
                                                                    <div
                                                                        class="service-details fonctionnalites-service-details">
                                                                        <p>1212112Avec ECAB®, vous n’aurez plus besoin
                                                                            que
                                                                            d’un seul logiciel pour gérer l’ensemble de
                                                                            vos
                                                                            factures destinées à vos clients et
                                                                            partenaires.
                                                                            Accédez rapidement à toutes vos factures
                                                                            depuis
                                                                            cet onglet.</p>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div style=" " class="service-box">
                                                            <div class="row" style="padding-left: 15px; ">
                                                                ...
                                                                <div class="col-lg-8 col-md-8 col-12"
                                                                    ...
                                                                    <div
                                                                        class="service-title fonctionnalites-service-title">
                                                                        <a href="#">Comptabilité</a></div>
                                                                    <div
                                                                        class="service-details fonctionnalites-service-details">
                                                                        <p>Vous n’avez plus à vous soucier des erreurs
                                                                            dans
                                                                            votre comptabilité, car notre solution ECAB®
                                                                            se
                                                                            charge de faciliter tous vos calculs et
                                                                            toutes
                                                                            vos démarches à partir de cet onglet.
                                                                            Cliquez
                                                                            dessus et retrouvez toutes les informations
                                                                            dont
                                                                            vous avez besoin pour la gestion comptable
                                                                            de
                                                                            société de transport.</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div style=" " class="service-box">
                                                            <div class="row" style="padding-left: 15px; ">
                                                                <div class="col-lg-4 col-md-4 col-12">
                                                                    <div class>
                                                                        <img class
                                                                            src=" assets/images/recruitements.jpg" alt
                                                                            style="width:250px">
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-8 col-md-8 col-12"
                                                                    ...
                                                                    <div
                                                                        class="service-title fonctionnalites-service-title">
                                                                        <a href="#">Recrutement</a></div>
                                                                    <div
                                                                        class="service-details fonctionnalites-service-details">
                                                                        <p> Gérez tous les recrutements en cours ou à
                                                                            venir
                                                                            de votre société depuis cet onglet. Accédez
                                                                            à la
                                                                            description des postes, créez vos offres et
                                                                            gérez vos ressources humaines beaucoup plus
                                                                            simplement.</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div style=" " class="service-box">
                                                            <div class="row" style="padding-left: 15px; ">
                                                                ...
                                                                <div class="col-lg-8 col-md-8 col-12"
                                                                    ...
                                                                    <div
                                                                        class="service-title fonctionnalites-service-title">
                                                                        <a href="#">Affiliation</a></div>
                                                                    <div
                                                                        class="service-details fonctionnalites-service-details">
                                                                        <p> Pourquoi ne pas obtenir de nouveaux clients
                                                                            grâce à un programme d’affiliation ? ECAB®
                                                                            vous
                                                                            aide à gérer tous vos affiliés et leurs
                                                                            commissions à partir de cette section claire
                                                                            et
                                                                            concise.</p>
                                                                    </div>
                                                                </div>
                                                ...
                                                <div id="feature-box3" style="display: none !important;">
                                                        ...
                                                        <div style=" " class="service-box">
                                                            <div class="row" style="padding-left: 15px; ">
                                                                ...
                                                                <div class="col-lg-8 col-md-8 col-12"
                                                                    ...
                                                                    <div
                                                                        class="service-details fonctionnalites-service-details">
                                                                        <p> Organisez votre semaine de travail
                                                                            sereinement à
                                                                            l’aide de l’outil de planification inclus
                                                                            dans
                                                                            notre solution tout-en-un. Gagnez du temps
                                                                            et ne
                                                                            manquez plus jamais une seule échéance.</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div style=" " class="service-box">
                                                            <div class="row" style="padding-left: 15px; ">
                                                                ...
                                                                <div class="col-lg-8 col-md-8 col-12"
                                                                    ...
                                                                    <div
                                                                        class="service-title fonctionnalites-service-title">
                                                                        <a href="#">Temps de travail</a></div>
                                                                    <div
                                                                        class="service-details fonctionnalites-service-details">
                                                                        <p>Vous avez des difficultés à suivre le temps
                                                                            de
                                                                            travail de vos chauffeurs ? C’est souvent
                                                                            une
                                                                            des plus grandes contraintes des gérants de
                                                                            société de transport. Mais, rassurez-vous,
                                                                            ECAB®
                                                                            vous aide à gérer tout cela de manière
                                                                            beaucoup
                                                                            plus sereine à partir de cette section.</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div style=" " class="service-box">
                                                            <div class="row" style="padding-left: 15px; ">
                                                                ...
                                                                <div class="col-lg-8 col-md-8 col-12"
                                                                    ...
                                                                    <div
                                                                        class="service-title fonctionnalites-service-title">
                                                                        <a href="#">Infractions routiéres</a></div>
                                                                    <div
                                                                        class="service-details fonctionnalites-service-details">
                                                                        <p> Malheureusement, il arrive parfois que vos
                                                                            chauffeurs commettent des infractions. Mais,
                                                                            votre logiciel ne vous laisse pas tomber !
                                                                            Retrouvez toutes les infractions à partir de
                                                                            cet
                                                                            écran et gérez le paiement des amendes plus
                                                                            facilement.</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div style=" " class="service-box">
                                                            <div class="row" style="padding-left: 15px; ">
                                                                ...
                                                                <div class="col-lg-8 col-md-8 col-12"
                                                                    ...
                                                                    <div
                                                                        class="service-title fonctionnalites-service-title">
                                                                        <a href="#">Gestion commercial</a></div>
                                                                    <div
                                                                        class="service-details fonctionnalites-service-details">
                                                                        <p> Gérez toutes vos actions commerciales liées
                                                                            à
                                                                            votre société de transport depuis cette
                                                                            partie.
                                                                            Fixez vos prix de vente et suivez
                                                                            l’évolution de
                                                                            votre chiffre d’affaires depuis cet onglet.
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                ...
                                                <div id="feature-box4" style="display: none !important;">
                                                        ...
                                                        <div style=" " class="service-box">
                                                            <div class="row" style="padding-left: 15px; ">
                                                                ...
                                                                <div class="col-lg-8 col-md-8 col-12"
                                                                    ...
                                                                    <div
                                                                        class="service-details fonctionnalites-service-details">
                                                                        <p> Pilotez tous les aspects de vos ressources
                                                                            humaines depuis cet onglet. Ciblez des
                                                                            candidats
                                                                            et gardez l’ensemble des dossiers de vos
                                                                            employés au même endroit pour une gestion
                                                                            simple
                                                                            et efficace.</p>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div style=" " class="service-box">
                                                            <div class="row" style="padding-left: 15px; ">
                                                                ...
                                                                <div class="col-lg-8 col-md-8 col-12"
                                                                    ...
                                                                    <div
                                                                        class="service-details fonctionnalites-service-details">
                                                                        <p> Gérez toutes les rémunérations de vos
                                                                            collaborateurs depuis cette page simplifiée.
                                                                            Accédez à vos fiches de paie et centralisez
                                                                            toutes les données simplement grâce à ECAB®.
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                ...
                                                <div id="feature-box5" style="display: none !important;">
                                                    <div class="col-sm-12 col-md-6">
                                                        <div class="service-box">
                                                            <div class="row" style="padding-left: 15px; ">
                                                                ...
                                                                <div class="col-lg-8 col-md-8 col-12"
                                                                    ...
                                                                    <div
                                                                        class="service-title fonctionnalites-service-title">
                                                                        <a href="#">Gestion de vos réservations</a>
                                                                    </div>
                                                                    <div
                                                                        class="service-details fonctionnalites-service-details">
                                                                        <p> Gardez l’esprit tranquille sur les
                                                                            réservations
                                                                            de vos clients ! ECAB® se charge de tout.
                                                                            Vous
                                                                            pourrez piloter toutes les courses grâce à
                                                                            notre
                                                                            logiciel.</p>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="service-box">
                                                            <div class="row" style="padding-left: 15px; ">
                                                                ...
                                                                <div class="col-lg-8 col-md-8 col-12"
                                                                    ...
                                                                    <div
                                                                        class="service-title fonctionnalites-service-title">
                                                                        <a href="#">Gestion de vos factures</a></div>
                                                                    <div
                                                                        class="service-details fonctionnalites-service-details">
                                                                        <p>ECAB® s’occupe de toutes vos factures pour
                                                                            vous
                                                                            permettre de souffler et de vous concentrer
                                                                            sur
                                                                            d’autres aspects de votre activité.</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="service-box">
                                                            <div class="row" style="padding-left: 15px; ">
                                                                ...
                                                                <div class="col-lg-8 col-md-8 col-12"
                                                                    ...
                                                                    <div
                                                                        class="service-title fonctionnalites-service-title">
                                                                        <a href="#">Planification</a></div>
                                                                    <div
                                                                        class="service-details fonctionnalites-service-details">
                                                                        <p> ECAB® vous aide dans toutes vos tâches de
                                                                            planification. Vous serez ainsi beaucoup
                                                                            plus
                                                                            organisé dans votre travail au quotidien.
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </div>
                            ...
                            <div class="col-sm-12 col-md-12 col-12 text-center" style="margin-top: 3rem;">
                                <a class="btn btn-primary" id="voirFeatureBtn"><i class="fa-solid fa-caret-down"></i>
                                    VOIR
                                    PLUS</a>
                            </div>
                        </div>
                ...
                <div class="col-sm-12 col-md-12 col-12">
                    <div class="buttons-holder" style="display: flex; justify-content: center;align-items: center;">
                        ...
                        <a style="border: 1px solid;background: linear-gradient(  #9fe925, #558407) !important;"
                            href="#" class="ybtn ybtn-header-color col-6" tabindex="0"><span
...
<script>
    const box1 = document.getElementById('feature-box1');
    const box2 = document.getElementById('feature-box2');
    const box3 = document.getElementById('feature-box3');
    const box4 = document.getElementById('feature-box4');
    const box5 = document.getElementById('feature-box5');
    const voirBtn = document.getElementById('voirFeatureBtn');

    let currentStep = 1;



    voirBtn.addEventListener('click', (event) => {
        ...
        if (currentStep === 1) {
            ...
            currentStep = 5;
            voirBtn.innerHTML = '<i class="fa-solid fa-caret-up"></i> VOIR MOINS';
            ...
            currentStep = 1;
            voirBtn.innerHTML = '<i class="fa-solid fa-caret-down"></i> VOIR PLUS';
        }
    });
</script>
...
<script>
    var icon = document.querySelectorAll('.arrow');
    // var pDiv = document.querySelector('.more-text');
    ...
    icon.forEach(q => {
        q.addEventListener("click", () => {
            var text = q.nextElementSibling;
            var iconElement = q.querySelector('i');
            text.style.display = text.style.display === "block" ? "none" : "block";
            q.style.transfrom = q.style.transfrom === "rotate(179deg)" ? "rotate(53deg)" :
                "rotate(179deg)";
