...
.sign i {
    ...
    .icon-div h6 img:nth-child(1) {
        width: 130px;
    }

    .icon-div h6 img:nth-child(2) {
        width: 18px;
    }
...
<hr class="lg">
<div id="temoignages" class="testimonial-block" style="scroll-margin-top: 200px;">
    <div class="wrapper">
        <div class="col-md-12">
            <h3 class="text-center row-title">Témoignages Clients</h3>

            <p class=" text-center row-subtitle" style="padding-bottom: 3px; margin-top: 44px;">Ce que nos clients
                disent de nous ?</p>
        </div>

        <div id="temoignage" class="h2_svg animate__animated animate__faster animate__zoomInRight"
        ...
        <div id="testmonialBlock" class="testmonialBlock">
            <div class="testimonial_lt">
                <div class="text1">
                    <span>Nous perdions beaucoup de temps dans la gestion du personnel et de la comptabilité de notre
                        société de transport scolaire. Je remercie donc ECAB® qui nous a permis de gagner du temps et de
                        pallier aux absences de nos collègues plus facilement.</span>
                    <div class="icon-div"
                        style="position: relative; height: 0; width: 100%; padding: 0; padding-bottom: 60px;">
                        <h6><img src="/assets/images/five_starNew.png" alt="" /> <img
                                src="/assets/images/greenright.png" alt="" /> Achat vérifié </h6>
                    </div>
                </div>
                <div class="namebox"> <img alt src="  assets/images/person2.png" style="width:100px;">
                    <div class="name">
                        <h5 class="authorName">Mme Sophie Lambert</h5>
                        <p>Directrice générale de société de transport scolaire</p>
                    </div>
            ...
            <div class="testimonial_lt">
                <div class="text1">
                    <span>Nous étions débordés et en manque de personnel pendant de longs mois avant de découvrir le
                        logiciel ECAB®. Un grand merci à toute l’équipe qui a su nous accompagner dans la prise en main
                        de cet outil qui a changé notre activité !</span>
                    <div class="icon-div"
                        style="position: relative; height: 0; width: 100%; padding: 0; padding-bottom: 60px;">
                        <h6><img src="/assets/images/five_starNew.png" alt="" /> <img
                                src="/assets/images/greenright.png" alt="" /> Achat vérifié </h6>
                ...
                <div class="namebox"> <img alt src="  assets/images/person3.png" style="width:100px;">
                    <div class="name">
                        <h5 class="authorName">Mme Julie Frenandez</h5>
                        <p>Présidente de société de transport handicapé</p>
                    </div>
            ...
            <div class="testimonial_lt">
                <div class="text1">
                    <span>Mon métier est une véritable passion pour moi, mais je ne suis pas expert dans la comptabilité
                        ou les démarches administratives. ECAB® a complètement changé mon travail et je peux me
                        concentrer sur les tâches qui me plaisent le plus grâce à cette solution tout-en-un.</span>
                    <div class="icon-div"
                        style="position: relative; height: 0; width: 100%; padding: 0; padding-bottom: 60px;">
                        <h6><img src="/assets/images/five_starNew.png" alt="" /> <img
                                src="/assets/images/greenright.png" alt="" /> Achat vérifié </h6>
                ...
                <div class="namebox"> <img alt src="  assets/images/person1.png" style="width:100px;">
                    <div class="name">
                        <h5 class="authorName">Mr Benis Karim</h5>
