        ...
        <div style="padding: 0 5px 0px 5px;">
            ...
            <div class="basic-chat-detail">
                ...
                <div id="supp_other2">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="input-group signupResBtnPopup2" style="width:27%;float:left;margin-right:5px;">
                                <span class="input-group-addon"><i class="fa fa-user"></i></span>
                            ...
                            <div class="input-group signupResBtnPopup2" style="width:33%;float:left;margin-right:5px;">
                                <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                <input id="name" type="text" maxlength="100" class="form-control s_firstname2"
                                    required="" name="name" placeholder="Nom*" value="">
                            </div>
                            <div class="input-group signupResBtnPopup" style="width:36.3%;float:left">
                                <span class="input-group-addon"><i class="fa fa-user"></i></span>
...
Accés Client
                ...
                <div class="col-12">
                    ...
                    <div class="navTop col-md-6">
                        <ul class="top-links ">
                            ...
                            <li menuitemname="133" class="" id="Primary_Navbar-133">
                                <a href=" announcements">
                                    <i class="fas fa-cogs"></i>&nbsp; Etat du Service
                                </a>
                            </li>
                            <li menuitemname="133" class="" id="Primary_Navbar-133">
                                <a href=" jobs">
                            ...
                            <li class="support-button-holder trans support-dropdown demo-button"
                                ...
                                <form method="post" action="cart.php">
                                    ...
                                    <select id="currencyHead" name="currency" onchange="submit()"
                                        ...
                                        <option style="color:#000" value="2">EURO</option>
    ...
    padding: 0 3px 0 3px !important;" menuitemname="943" class=" removeFocus1" id="Secondary_Navbar-943">
                                <i class="fa fa-lock"></i> <a href="https://ecab.live/client/login.php">
                                    Accés Client
                                </a>
                            </li>
