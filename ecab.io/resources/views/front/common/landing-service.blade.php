<style>
    ...
    .feature-box.feature-d4 {
        height: 240px;
    }

    .feature-box.feature-d3 {
        height: 251px;
    }
...
<div id="services" class="container-fluid pt-2" style="padding-top: 25px;scroll-margin-top: 200px;">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
      		...
      		c1.8,0.1,3.7,0.1,5.5,0.3C343.2,34.3,338,32.9,331.8,32.4z"></path>
                ...
                <div class="row-subtitle">Gérez votre société de transport de personnes en toute tranquillité !</div>
            </div>

        </div>
        <div class="row" id="serviceBox">
            <div class="col-sm-12 col-md-6">
                <div class="service-box">
                    <div class="service-icon">
                        <img src="assets/images/clients.jpg" alt>
                    </div>
                    <div class="service-title"><a href="#">Gestion de vos équipes</a></div>
                    <div class="service-details">
                        <p>La solution ECAB® prend en charge la gestion de l’ensemble de vos chauffeurs. Vous pouvez
                            retrouver 
                        </p>
                        
                    <div class="arrow"><i class="fa-solid fa-angle-down"></i></div>
                        <p class="more-text" style="display: none;">
                            toutes les informations nécessaires sur vos employés en un instant depuis le même
                            écran de contrôle.
                        </p>
            ...
            <div class="col-sm-12 col-md-6">
                <div class="service-box">
                    ...
                    <div class="service-title"><a href="#">Gestion de vos réservations</a></div>
                    <div class="service-details">
                        <p>Gardez l’esprit tranquille sur les réservations de vos clients ! ECAB® se charge de tout.</p>
                            <div class="arrow"><i class="fa-solid fa-angle-down"></i></div>
                        <p class="more-text" style="display: none;">
                            Vous pourrez piloter toutes les courses grâce à notre logiciel.
                        </p>
                    </div>
            ...
            <div class="col-sm-12 col-md-6">
                <div class="service-box">
                    ...
                    <div class="service-title"><a href="#">Gestion de vos factures</a></div>
                    <div class="service-details">
                        <p>ECAB® s’occupe de toutes vos factures pour vous permettre de souffler et de vous concentrer
                            sur  </p>
                            <div class="arrow"><i class="fa-solid fa-angle-down"></i></div>
                        <p class="more-text" style="display: none;">
            ...
            <div class="col-sm-12 col-md-6">
                <div class="service-box">
                    ...
                    <div class="service-title"><a href="#">Planification</a></div>
                    <div class="service-details">
                        <p>ECAB® vous aide dans toutes vos tâches de planification. Vous serez ainsi beaucoup plus
                             </p>
                            <div class="arrow"><i class="fa-solid fa-angle-down"></i></div>
                        <p class="more-text" style="display: none;">
            ...
            <div class="col-sm-12 col-md-6">
                <div class="service-box">
                    ...
                    <div class="service-title"><a href="#">Gestion de vos réservations</a></div>
                    <div class="service-details">
                        <p>Gardez l’esprit tranquille sur les réservations de vos clients ! ECAB® se charge de tout.
                            Vous pourrez  </p>
                            <div class="arrow"><i class="fa-solid fa-angle-down"></i></div>
                        <p class="more-text" style="display: none;">
                            piloter toutes les  courses grâce à notre logiciel.
                        </p>
        ...
        <div class="row" id="serviceBox2" style="display: none;">
            <div class="col-sm-12 col-md-6">
                <div class="service-box">
                    <div class="service-icon">
                        <img src="assets/images/clients.jpg" alt>
        ...
        <div class="row" id="serviceBox3" style="display: none;">
            <div class="col-sm-12 col-md-6">
                <div class="service-box">
                    <div class="service-icon">
                        <img src=" assets/images/clients.jpg" alt>
                    ...
                    <div class="service-details">
                        <p>ECAB® s’occupe de toutes vos factures pour vous permettre de souffler et de vous concentrer
                            ...
                            <div class="arrow"><i class="fa-solid fa-angle-down"></i></div>
                        <p class="more-text" style="display: none;">
                           d’autres aspects de votr activité.
                        </p>
    ...
    <div class="col-sm-12 col-md-12 col-12 text-center" style="margin-top: 3rem;">
        <a class="btn btn-primary" id="voirPlusBtn"><i class="fa-solid fa-caret-down"></i> VOIR PLUS</a>
    </div>
</div>
...
<script>
    const box1 = document.getElementById('serviceBox');
    const box2 = document.getElementById('serviceBox2');
    const box3 = document.getElementById('serviceBox3');
    ...
    voirBtn.addEventListener('click', (event) => {
        ...
        if (currentStep === 1) {
            // ১ম ক্লিকে: box2 দেখাও
            box2.style.display = 'block';
            currentStep = 2;
        } else if (currentStep === 2) {
            // ২য় ক্লিকে: box3 দেখাও + বাটন টেক্সট 'CACHER' করো
            box3.style.display = 'block';
            currentStep = 3;
            voirBtn.innerHTML = '<i class="fa-solid fa-caret-up"></i> VOIR MOINS';
        } else if (currentStep === 3) {
            // ৩য় ক্লিকে: box3 hide করো
            box3.style.display = 'none';
            currentStep = 4;
        } else if (currentStep === 4) {
            // ৪র্থ ক্লিকে: box2 hide করো + বাটন টেক্সট 'VOIR PLUS' করো
...
<script>
    ...
    icon.forEach(q => {
        q.addEventListener("click", () =>{
            ...
            q.style.transfrom = q.style.transfrom === "rotate(179deg)" ? "rotate(53deg)" : "rotate(179deg)";

            if(text.style.display === "block"){
                iconElement.style.transform = "rotate(179deg)";
            }else{
